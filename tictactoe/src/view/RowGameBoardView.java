...
public class RowGameBoardView implements RowGameView{
    ...
    // in this it will take the input from the interface and calls the updateblock model 
    ...
    // for extra protection I have made the class private
    private void updateBlock(RowGameModel gameModel, int row, int col) {
